...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="p" ><i class="icon_"><img src="NiceAdmin/img/Iconos/per.png"></i>Gestionar Clientes</h3>
                </div>
            </div>           
            </div-->
            ...
            <div class="panel-heading" >
                            ...
                            <div class="panel-actions">
                                <a class="boton" href="crearCliente.php"><i class="icon_"></i>Agregar Cliente</a>
                            </div>
                        </div>
