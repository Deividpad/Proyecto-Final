...
<head>
    ...
    <!--external css-->
   <!-- <link rel="stylesheet" href="NiceAdmin/css/principal.css">-->
    <!-- font icon -->
...
<section id="container" class="">
    ...
    <section id="main-content">
        <section class="wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h3 class="p" >Vuelos<i class="icon_"><img src="NiceAdmin/img/Iconos/vuelos%20.png"></i> </h3>
                </div>
            </div>
        </section>
            <div class="content-all">
                <div class="content-carrousel">
                    <fi><img src="img/001.jpeg"></fi>
                    <fi><img src="img/002.jpg"></fi>
                    <fi><img src="img/003.jpg"></fi>
                    <fi><img src="img/004.jpg"></fi>
                    <fi><img src="img/005.jpg"></fi>
                    <fi><img src="img/006.jpg"></fi>
                </div>
            </div>
        ...
        <section class="wra">
            ...
            <div class="panel-heading" >
                <h3 class="p" <i class="icon_" style="color: black"><img src="NiceAdmin/img/Iconos/vuelos%20.png"></i> Vuelos Activos<i class="icon_"> <img src="NiceAdmin/img/Iconos/vuelos%20.png"></i> </h3>
