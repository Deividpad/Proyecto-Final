    ...
    <div class="container">
      ...
      <form class="login-form"  name="frmLogin">
        <div class="login-wrap">
            <p class="login-im"><i class="icon_lock_"><img src="NiceAdmin/img/admin_2.png"></i></p>
            ...
            <div class="input-group">
                ...
                <input type="password" id="Password" name="Contraseña" class="form-control" placeholder="Password">
            </div>
          <!--  <label class="checkbox">
                <input type="checkbox" value="remember-me"> Remember me
                <span class="pull-right"> <a href="#"> Forgot Password?</a></span>
            </label>-->
            <button class="btn btn-primary btn-lg btn-block" id="btnEnviar" name="btnEnviar" type="button">Login</button>
